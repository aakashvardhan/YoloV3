...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./content/YoloV3/cfg/yolov3-custom.cfg', help='*.cfg path')
    parser.add_argument('--data', type=str, default='/content/YoloV3/data/customdata/custom.data', help='*.data path')
    ...
    parser.add_argument('--weights', type=str, default='/content/YoloV3/weights/yolov3-spp-ultralytics.pt', help='initial weights path')
